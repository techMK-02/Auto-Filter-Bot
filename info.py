...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7404299810 7782885132').split()]
USERNAME = environ.get('USERNAME', 'https://telegram.me/DevThanos02')
...
URL = environ.get('URL', 'https://shallow-cybil-telegram-features-3280fd42.koyeb.app/')
